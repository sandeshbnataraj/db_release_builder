/*==============================================================*/
/* Deployment Database: deployment_db_name                        */
/*==============================================================*/

declare @version varchar(50),
        @oldversion varchar(50)
		
set @oldversion = old_version
set @version = ( select rtrim(ltrim(dbversion_id)) from system_dbversion where dbversion_id like @oldversion + '%' )

if (@version is NULL)

raiserror('Deployment aborted due to incompatible deployment_db_name version!!!',20,-1) WITH LOG

else

print 'Proceed with the deployment as correct deployment_db_name version is being used...'
